...
import AddInventoryUsage from './InventoryUsage';
      ...
      <div className="InventpryTable GridData">
                ...
                {inventoryData.map((inventory, index) => (
                    <div className="row GridData" key={index}>
                        ...
                        <img src={Images.gridEdit} className='cursor-pointer iconsize me-2' title='Edit Inventory'
                        onClick={(e) => getInventoryById(inventory.id)}/>
                        <label title='Add Usage'  onClick={() => {
              setInventoryUsagePopup(true);
            }}><i class="bi bi-clock-history"></i></label> 
                        </div>
                    </div>
                ))}
